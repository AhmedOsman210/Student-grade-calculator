...
function About() {
    return (
        <div className="p-6 text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">This application helps students calculate their grades
               based on their scores and the weight of each assignment. It's designed 
               to be easy to use and provide accurate results.</p>
